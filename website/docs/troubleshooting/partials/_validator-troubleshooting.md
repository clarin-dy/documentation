<table>
    ...
    <td><code>Could not request attestation to sign at slot error=rpc error: code = Unavailable desc = the node is currently optimistic and cannot serve validators</code></td>
      <td>This usually means that your execution client isn't yet synchronized. Visit <a href='[https://github.com/prysmaticlabs/prysm/issues/11130#issuecomment-1199984124](https://docs.prylabs.network/docs/monitoring/checking-status)'>Check Node and Validator Status</a>. </td>
    </tr>
</table>
